...
public List<product> getProductsByCategory(String category, int offset, int limit) {
    List<product> list = new ArrayList<>();
    String sql = "SELECT * FROM products WHERE status = 1 AND category = ? ORDER BY id OFFSET ? ROWS FETCH NEXT ? ROWS ONLY";
...
public int countProductsByCategory(String category) {
    String sql = "SELECT COUNT(*) FROM products WHERE status = 1 AND category = ?";
...
public List<product> getProductsByCategoryAndDescription(String category, String description, int offset, int limit) {
    List<product> list = new ArrayList<>();
    String sql = "SELECT * FROM products WHERE status = 1 AND category = ? AND description = ? ORDER BY id OFFSET ? ROWS FETCH NEXT ? ROWS ONLY";
...
public int countProductsByCategoryAndDescription(String category, String description) {
    String sql = "SELECT COUNT(*) FROM products WHERE status = 1 AND category = ? AND description = ?";
