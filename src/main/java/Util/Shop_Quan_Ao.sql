...
VALUES
  ('alice@example.com','123','Alice Nguyen','admin','Hanoi, Vietnam'),
  ('bob@example.com','123','Bob Tran','user','Hanoi, Vietnam'),
  ('carol@example.com','123','Carol Le','user','Ho Chi Minh City, Vietnam'),
  ('david@example.com','123','David Pham','user','Da Nang, Vietnam'),
  ('eve@example.com','123','Eve Ho','user','Hue, Vietnam');
